const mockReport = {
  "contact_details": {
      ...
      "phone_numbers": [
          "+44 20 8644 4224 - registered on TPS"
      ],
      "postal_code": "SM3 9AG",
      "region": "Western Europe",
      "websites": [
          "www.wrightglazing.co.uk"
      ]
  },
  "financials": {
      "2020": {
              ...
              "details": [
                  {
                      ...
                      "MortgageDetails": "BY WAY OF A FIRST FIXED AND FLOATING CHARGE ON THE PROPERTY KNOWN AS 94A PRIORYROAD, SUTTON, SM3 8LNCONTAINS FIXED CHARGE.CONTAINS FLOATING CHARGE.LOATING CHARGE COVERS ALL THE PROPERTY OR UNDERTAKING OF THE COMPANY.CONTAINS NEGATIVE PLEDGE.",
