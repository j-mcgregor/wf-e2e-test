...
export const SpecialistsForm: FC<SpecialistsFormProps> = ({headings}) => {
    const { register, handleSubmit } = useForm<SpecialistsFormInput>();
    // eslint-disable-next-line no-console
    const onSubmit: SubmitHandler<SpecialistsFormInput> = data => console.log(data);
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="shadow sm:rounded-md sm:overflow-hidden">
                    <div className="bg-white py-6 px-4 space-y-6 sm:p-6">
                        <div>
                            <HashHeader text={headings[1]['title']}
                                        classname={"text-lg leading-6 font-medium text-gray-900"}/>
                            <p className="mt-1 text-sm text-gray-500">Change base preferences.</p>
                        </div>
                        {/*#localisation*/}
                        <div className="grid grid-cols-6 gap-6">
                            <div className="col-span-6 sm:col-span-3">
                                ...
                                <p className="mt-1 text-sm text-gray-500">Set your language
                                    preferences.</p>
                                <select
                        ...
                        <div className="grid grid-cols-6 gap-6">
                            <div className="col-span-6 sm:col-span-3">
                                ...
                                <p className="mt-1 text-sm text-gray-500">Change your default country to
                                    run your reports in.</p>
                                <select
                                    {...register("reporting")}
                                    id="reporting"
                                    name="reporting"
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                ...
                                <p className="mt-1 text-sm text-gray-500">Change the default reporting
                                    currency.</p>
                        ...
                        <div className="grid grid-cols-6 gap-6">
                            <div className="col-span-6 sm:col-span-3">
                                ...
                                <p className="mt-1 text-sm text-gray-500">Change the screen you see on
                                    your first login.</p>
                                <select
                                ...
                                >
                                    ...
                                    <option value={"differentDashboard"}>Different Dashboard</option>
                                </select>
                            </div>
                        </div>
                    </div>
