...
const PersonalInformationForm: FC<PersonalInformationProps> = ({headings}) => {
    const { register, handleSubmit } = useForm<PersonalInformationFormInput>();
    // eslint-disable-next-line no-console
    const onSubmit: SubmitHandler<PersonalInformationFormInput> = data => console.log(data);
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="shadow sm:rounded-md sm:overflow-hidden">
                <div className="bg-white py-6 px-4 space-y-6 sm:p-6">
                    <div>
                        <HashHeader text={headings[0]['title']}
                                    classname={"text-lg leading-6 font-medium text-gray-900"}/>
                        <p className="mt-1 text-sm text-gray-500">Change or update your personal
                            information</p>
                    </div>
                    ...
                    <div className="grid grid-cols-6 gap-6">
                        ...
                        <div className="col-span-6 sm:col-span-6 lg:col-span-4">
                            <label htmlFor="coHeadquartLocation"
                                   className="block text-sm font-medium text-gray-700">
