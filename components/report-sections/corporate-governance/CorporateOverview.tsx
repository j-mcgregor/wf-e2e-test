  ...
  return (
    <div className="bg-white shadow-sm rounded-sm mx-4 sm:mx-0">
      <div className="grid grid-cols-2 md:grid-cols-3 grid-rows-2 ">
        <div className="p-4 border-b border-r" data-testid="corp-ceo-testid">
          <p className="font-bold">{ceo}</p>
          <p>{t('ceo')}</p>
        </div>
        <div className="p-4 border-b md:border-r" data-testid="corp-cfo-testid">
          <p className="font-bold">{cfo}</p>
          <p>{t('cfo')}</p>
        </div>
        <div
          className="p-4 border-b border-r md:border-r-0"
        ...
        <div
          className="p-4 border-b md:border-r"
          data-testid="corp-directors-testid"
        >
          <p className="font-bold">{directors}</p>
          <p>{t('directors')}</p>
        </div>
        <div className="p-4 border-r" data-testid="corp-shareholders-testid">
          <p className="font-bold">{shareholders}</p>
          <p>{t('shareholders')}</p>
        </div>
        <div className="p-4 " data-testid="corp-snr-mgmt-testid">
